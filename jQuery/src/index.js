        ...
        items: [{
            ...
            items: [{
                ...
                editorOptions: {
                    placeholder: 'Filter...',
                    onKeyUp: ({event}) => {
                        scheduler.option('dataSource', setAppointments(
                            form.option('items[0].items[1].value'),
                            form.option('items[0].items[2].value'),
                            form.option('items[0].items[3].value'),
                            event.target.value
                        ))
                    }
                }
                ...
                editorOptions: {
                    type: 'date',
                    onValueChanged: (e) => {
                        textInputValue = $('#form').find('input[name="text"]').val();

                        form.option('items[0].items[1].value', e.value);
                ...
                editorOptions: {
                    ...
                    onValueChanged: (e) => {
                        ...
                        form.option('items[0].items[2].value', e.value);
                ...
                editorOptions: {
                    onValueChanged: (e) => {
                        ...
                        form.option('items[0].items[3].value', e.value);
...
const setAppointments = (startDate, endDate, useDisable, filterValue) => {
    if (useDisable)
